...
php7.1-gd php7.1-curl php7.1-memcached \
...
sed -i "s/upload_max_filesize = .*/upload_max_filesize = 500M/" /etc/php/7.1/fpm/php.ini
sed -i "s/post_max_size = .*/post_max_size = 500M/" /etc/php/7.1/fpm/php.ini
